...
local function saveFile(path)
  ...
  if file then
    ...
    GUI.alert("Failed to open file for writing NPP: " .. tostring(reason))
  end
end
  ...
  if not bottomToolBar.hidden and searchInput.text ~= "" then
    ...
    for line = findStartFrom, #lines do
      ...
      if success then
        ...
        GUI.alert("Wrong searching regex NPP")
      end
    end
